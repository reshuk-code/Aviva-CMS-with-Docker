...
/** "12 Mar 2026" — short, unambiguous, and stable across locales. */
...
/** "3 minutes ago". Falls back to a date once past a week. */
...
/** Datetime-local inputs need "YYYY-MM-DDTHH:mm", not an ISO string. */
